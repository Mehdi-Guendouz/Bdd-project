  ...
  return (
    <div className="feed section">
      <div className="title">
          ...
          <div className="box">LET'S EXPLORE OUR FEED</div>
          {/* <img src="/img/Ellipse 32.png" alt=""> */}
      </div>
      <div className="content">
          ...
          <div className="persons grid grid-cols-3  gap-10 w-full">
              <div className="text-[18px] flex items-center jusctify-center flex-col">
                <div className=''>
      ...
      <div className="">
          ...
          <div className="subtitle">
              {/* <img src="/img/Ellipse 32.png" alt=""/> */}
              <div className="box">ROLE 2</div>
              {/* <img src="/img/Ellipse 32.png" alt=""/> */}
          </div>
          <div className="subtitle">
              {/* <img src="/img/Ellipse 32.png" alt=""/> */}
              <div className="box">ROLE 3</div>
              {/* <img src="/img/Ellipse 32.png" alt=""/> */}
          </div>
      </div>
      <SignupForm/>
